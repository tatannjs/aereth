...
OWindow::OWindow()
{
	...
	m_handle = CreateWindowEx(NULL, MAKEINTATOM(classId), L"aereth", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, NULL, NULL);
	...
	m_context = wglCreateContextAttribsARB(hDC, 0, openGLContextAttributes);
	assert(m_context);
}
